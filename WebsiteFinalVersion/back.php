<?php
    ...
    include './php/comments.back.inc.php';
?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="./css/back_css.css">
...
<body>
    ...
    <section id="services">
        ...
        <div class="services-info">
                <h1>BA<span id="blue">CK</span></h1>

                <p>Are you wondering how to get a stronger back? The following 6 bodyweight exercises will give you a great at home back workout. You don’t need any equipment for these – just your own body weight.
                ...
                <p>So, you’re ready to round out your training with these top 6 bodyweight back exercises? Whether you’re a beginner runner who wants to develop a stronger stride, an experienced runner interested in improving your pace, or you just want to develop a stronger core for better overall health, home back workouts are a convenient way to acquire the muscles you need to achieve your goal.

                    And remember to pace yourself and think about how you breathe when you add these bodyweight back exercises to your exercise routine. Take care of your body and it will serve you well. Let’s get started!</p>
                
                <h3>LOW PLANK</h3>

                    <center>
                        <img src="./images/09.02._Sven_Low-plank.jpg">
                    </center>

                    <h4>STARTING POSITION</h4>
                        <P>Lie on your stomach. Bend your elbows directly under your shoulders and place your forearms on the floor. Extend your legs and rest the balls of your feet on the floor.</P>
                    
                    <h4>HOW TO DO THE EXERCISE:</h4>

                    <p>Lift your hips and thighs off the floor until your body is parallel to the floor. Engage your core and make sure that your body forms a straight line from your head to your feet. Tuck your pelvis under to ensure a flat back. Don’t let your lower back (lumbar region) sag or lift. In the thoracic region, pull your shoulder blades in and down.</p>

                    <h3>HIGH PLANKS</h3>

                        <center>
                            <img src="./images/09.02._Sven_High-plank.jpg">
                    ...
                    <h3>BRIDGE</h3>
                        ...
                        <center>
                            <img src="./images/09.02._Sven_Bridge.jpg">
                        </center>
                    ...
                    <h3>SUERMAN</h3>
                            <center>
                                <img src="./images/09.02._Sven_Superman.jpg">
                            </center>
                    ...
                    <h3>QUADRUPED LIMB RAISES</h3>
                            <center>
                                <img src="./images/09.02._Sven_Quadrated-limb-raised.jpg">
                            </center>
                    ...
                    <h3>PUSH-UP</h3>
                            <center>
                                <img src="./images/09.02._Sven_Push-ups.jpg">
                            </center>
