<?php
    ...
    include './php/comments.chest.inc.php';
?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="./css/chest_css.css">
...
<body>
    ...
    <section id="services">
        ...
        <div class="services-info">
                <h1>CHE<span id="blue">ST</span></h1>

                <p>Every man who works out is after a muscular chest, but to build one you don't have to spend hours and hours benching in the gym. You can build a seriously impressive pair of pecs at home, if you know how, and we're here to teach you.
                ...
                <div class="clip">
                    <center>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/BkS1-El_WlE?start=5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </center>
                </div>

                <div class="clip_2">
                    <center>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/0bHt0OKU5as?start=11" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <br><br><br>
